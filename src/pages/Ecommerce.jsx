...
const Ecommerce = () => {
  ...
  return (
    <div className="mt-24">
        ...
        <div className="bg-white darg:text-gray-500 dark:bg-secondary-dark-bg shadow-2xl h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center"> 
            <div>
              ...
              <p className="text-2xl">$6,448.78</p>
            </div>
            <button
            type='button'
      ...
      <div>
        <div
        className='rounded-2xl shadow-2xl md:w-400 p-4 m-3'
        style={{ backgroundColor:currentColor}}
        >
          <div className="flex justify-between items-center">
            <p className="font-semibols text-2xl text-white">Earnings</p>
    ...
    <div className="flex gap-10 justify-center flex-wrap m-4">
      <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg shadow-2xl shadow-2xl p-6 rounded-2xl">
        ...
        <div className="flex items-center justify-between border-t-1 border-color mt-5">
          <div className="mt-3">
            <Button
            color='white'
            bgColor={currentColor}
      ...
      <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg shadow-2xl p-6 rounded-2xl w-96 md:w-760'>
    ...
    <div className="flex flex-wrap justify-center">
      <div className="bg-white md:w-400 dark:text-gray-200 dark:bg-secondary-dark-bg shadow-2xl rounded-2xl p-6 m-3">
        <div className="flex justify-between">
      ...
      <div className="bg-white w-400 dark:text-gray-200 dark:bg-secondary-dark-bg shadow-2xl rounded-2xl p-6 m-3">
        <div className="flex justify-between">
          <p className="text-xl font-semibold">MadicalPro Branding</p>
          <button
          type='type'
          className='text-xl font-semibold text-gray-500'
          >
        ...
        <div className="border-b-1 border-color pb-4 mt-2">
          ...
          <div className="flex gap-4">
            {medicalproBranding.teams.map((item) => (
              ...
              className='cursor-pointer hover:drop-shadow-xl text-white py-0.5 px-2 rounded-lg text-xs'
              >
                {item.name}
              </p>
            ))}
